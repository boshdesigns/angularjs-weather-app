weatherApp.controller('forecastController', ['$scope', '$rootScope', '$routeParams', '$resource', 'weatherService', 'GetForecast', function($scope, $rootScope, $routeParams, $resource, weatherService, GetForecast) {
    ...
    // The forecast results is in a factory which is being injected into this controller. Using a factory for the http callback stores the info plus makes it usable over different controllers instead of just the one.
